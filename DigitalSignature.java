...
boolean isVerified = verifySignature(originalMessage.getBytes(), digitalSignature, 
publicKey); 
System.out.println("Signature Verified: " + isVerified); 
String tamperedMessage = "This is a tampered message."; 
System.out.println("\nTampered Message: " + tamperedMessage); 
boolean isTamperedVerified = verifySignature(tamperedMessage.getBytes(), 
...
public static boolean verifySignature(byte[] data, byte[] digitalSignature, PublicKey 
